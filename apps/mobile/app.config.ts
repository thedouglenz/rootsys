    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active trellis agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow trellis to connect to trellis servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow trellis to access your camera so you can scan pairing QR codes.",
