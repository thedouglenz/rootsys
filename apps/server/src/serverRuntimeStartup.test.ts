    ...
    Effect.gen(function* () {
      ...
      yield* ServerRuntimeStartup.launchStartupHeartbeat.pipe(
        Effect.provideService(ProjectionSnapshotQuery.ProjectionSnapshotQuery, {
          ...
          getDagSnapshot: () => Effect.succeed(Option.none()),
          listDagShells: () => Effect.succeed([]),
          findDagNodeByThreadId: () => Effect.succeed(Option.none()),
  ...
  return Effect.gen(function* () {
    ...
    const targets = yield* ServerRuntimeStartup.resolveAutoBootstrapWelcomeTargets.pipe(
      ...
      Effect.provideService(ProjectionSnapshotQuery.ProjectionSnapshotQuery, {
        ...
        getDagGraph: () => Effect.die("unused"),
        getDagSnapshot: () => Effect.die("unused"),
        listDagShells: () => Effect.die("unused"),
        findDagNodeByThreadId: () => Effect.die("unused"),
        searchThreads: () => Effect.succeed({ matches: [] }),
      }),
