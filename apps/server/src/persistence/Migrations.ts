...
import Migration0041 from "./Migrations/041_ProjectionDags.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadsDagLink.ts";
import Migration0043 from "./Migrations/043_McpCredentials.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionDags", Migration0041],
  [42, "ProjectionThreadsDagLink", Migration0042],
  [43, "McpCredentials", Migration0043],
] as const;
