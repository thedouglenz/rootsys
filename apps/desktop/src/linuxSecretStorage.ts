...
function getGnomeKeyringRemediationMessage(): string {
  return "trellis could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart trellis.";
}

function getKWalletRemediationMessage(): string {
  return "trellis could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart trellis.";
}
