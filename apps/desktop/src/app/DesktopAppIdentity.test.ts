...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/trellis.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/trellis.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["trellis (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "trellis (Alpha)");
