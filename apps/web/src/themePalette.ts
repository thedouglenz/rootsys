...
/**
 * The palette rootsys wears with no theme installed, captured from the app's
...
/**
 * The standard rootsys look as a theme palette, for seeding a new theme when
...
/**
 * The status colors rootsys shows without a theme, read from the app's own
