...
/**
 * The palette trellis wears with no theme installed, captured from the app's
...
/**
 * The standard trellis look as a theme palette, for seeding a new theme when
...
/**
 * The status colors trellis shows without a theme, read from the app's own
