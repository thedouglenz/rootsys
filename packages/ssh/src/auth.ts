...
# Invoked by ssh via SSH_ASKPASS when rootsys re-runs ssh with a cached password
...
printf 'rootsys ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when rootsys re-runs\r
...
[Console]::Error.WriteLine("rootsys ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
