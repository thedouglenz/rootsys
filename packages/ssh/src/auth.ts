...
# Invoked by ssh via SSH_ASKPASS when trellis re-runs ssh with a cached password
...
printf 'trellis ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when trellis re-runs\r
...
[Console]::Error.WriteLine("trellis ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
